...
// function a(data, b) {
//     let dataB = data.find(ele=>ele)
//     console.log(dataB)
//     return b(dataB,c)
// }
// function b(dataFromA, c) {
//     const dataC = dataFromA.albums.find(d=>d);
//     console.log(dataC)
//     return c(dataC, d)
// }

// function c(dataFromB, d) {
//     const dataC =  dataFromB.songs;
//     return d(dataC, e)
// }

// function d(dataFromC, e) {
//     console.log(dataFromC)
//     const dataD  = dataFromC.filter(d=>{
//         let m =  d.length.split(':');
//         return +m.join('') >= 430;
//     });
//     return e(dataD)
// }
// function e(dataFromD) {
//     return dataFromD;
// }
let timeStart;
let timeEnd;
...
let cbhell = a(music, b);

let makeSure = Date.now();
console.log(makeSure - timeEnd);
console.log("it took ", timeEnd - timeStart);
